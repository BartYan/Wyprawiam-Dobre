...
<body <?php body_class() ?>>
  ...
  <header>
    <nav class="nav">
      ...
      <ul class="menu">
        <li class="menu_item">
          <a class="menu_item-link menu_active" href="index.html">główna</a>
        </li>
        <li class="menu_item">
          <a class="menu_item-link" href="recipes.html">przepisy</a>
        </li>
        <li class="menu_item">
          <a class="menu_item-link" href="blog.html">blog</a>
        </li>
        <li class="menu_item">
          <a class="menu_item-link" href="about.html">o nas</a>
        </li>
        <li class="menu_item">
          <a class="menu_item-link" href="contact.html">kontakt</a>
        </li>
      </ul>
    </nav>
  </header>