        ...
        <div class="recipe_row">
            ...
            <div class="recipe_column filter--show tag-breakfast">
                ...
                <div class="card_box">
                    ...
                    <a href="orange_pancakes.html" class="card_box-button">zobacz przepis <i
                            class="card_box-button--arrow" aria-hidden="true">&#8594</i></a>
                </div>
                <!--RECIPE CARD THE END-->
            </div>
        ...
        <div class="card_box-icons">
          ...
          <a href="orange_pancakes.html" class="card_box-button">zobacz przepis <i class="card_box-button--arrow"
            ...
            <div class="recipe_column filter--show tag-breakfast">
                <!--RECIPE CARD-->
                <div class="card_box">
                    <img class="card_box-img" src="<?php echo get_stylesheet_directory_uri() ?>/img/photos/owsianka.jpg" alt="Owsianka z Owocami">
