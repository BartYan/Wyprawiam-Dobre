...
<div class="comments">
    ...
    <div class="comments-list">
        ...
        <p class="no-comments">Ten wpis nie posiada jeszcze żadnych komentarzy.</p>
    ...
    <div id="respond">
        ...
        <form id="commentform" method="post" action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php">
            ...
            <p>Zalogowany jako: 
                <a class="user__logged"
                    href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity ?></a>
                <a href="<?php echo wp_logout_url(get_permalink()); ?>">Wyloguj się</a></p>
            ...
            <textarea class="textArea" name="comment" placeholder="Treść komentarza" rows="5" cols="50"></textarea>
